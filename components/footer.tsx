      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-foreground/60 text-sm mb-3">Kathmandu, Koteshwor (Opp. Bhatbhateni), Nepal</p>
            <p className="text-foreground/60 text-sm mb-3">info@smsitsolutions.com.au</p>
            <div className="flex gap-3">
              {/* <a href="#" className="text-foreground/60 hover:text-primary transition-colors">
                <Github size={18} />
              </a> */}
              <a href="https://www.facebook.com/share/1BqXpdBpZH/" className="text-foreground/60 hover:text-primary transition-colors">
                <Facebook size={18} />
              </a>
              {/* <a href="#" className="text-foreground/60 hover:text-primary transition-colors">
                <Twitter size={18} />
              </a> */}
              {/* <a href="info@smsitsolutions.com.au" className="text-foreground/60 hover:text-primary transition-colors">
                <Mail size={18} />
              </a> */}
            </div>
          </div>
